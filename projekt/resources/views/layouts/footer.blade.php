                ...
                <ul class="list-inline list-unstyled">
                    <li class="list-inline-item">
                        <a href="mailto:tomasz.ostrowski1@pollub.edu.pl" target="_blank" class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <li class="list-inline-item">
                        <a href="https://github.com/IDontCareKappa" target="_blank" class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-github" viewBox="0 0 20 20">
